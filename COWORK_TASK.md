...
**最重要: 独自視点の配分ルール**
- 記事全体の比率は **情報整理 6 : 独自視点 4** を目指す
- AIが書ける「ありきたりなまとめ」には価値がない。「この人の視点で読みたい」と思わせる記事にする
- Google の Information Gain Score（情報獲得スコア）は「既存コンテンツに対してどれだけ新しい情報を追加しているか」を測定している。独自視点こそが SEO とLLMO の差別化の核

```
（冒頭リード文 — 記事で最も重要な部分）
- ニュースの要約ではなく、**このニュースに対する自分の率直な反応**から始める
- 「正直これを見て最初に思ったのは〜」「これ、地味に見えるけど〜」のような切り出し
- 冒頭150文字以内に「何のニュースか」+「自分はどう見ているか」を凝縮する
- ※ LLMがAI検索の回答で引用するのはこの冒頭部分。ここに独自の切り口があるかどうかで引用されるか決まる
...
- 関連する過去の出来事との繋がり
- 競合の動向
- ここにも独自視点を挟む:「個人的に引っかかるのは〜」「これ、表面的にはAの話だけど本質はBだと思う」
...
- ここが記事の差別化ポイント
- 可能なら実際に触ってみた所感、スクリーンショット、コード例を入れる
...
- ただし事実と考察の境界を明確にする
- 「消防士時代の経験に照らすと」「前職の現場で考えると」のような他の誰にも書けない視点は積極的に使う

## まとめ
- 今後の展望や注目ポイントを1〜2文
- 短く。きれいにまとめすぎない
- 最後に一言、個人的な期待や本音を添える（「正直、一番気になってるのは〜」）
...
- **ニュースの解説者ではなく、ニュースにワクワクしている当事者として書く**
- 「会食や忖度みたいな無駄がテクノロジーで消えていく世界」を歓迎するスタンス
- 技術の進歩に対して素直に興奮している温度感を出す
...
- [ ] **冒頭リード文に「自分はこう見ている」という独自の切り口があるか（ニュース要約だけで始まっていないか）**
- [ ] **記事全体で独自視点が4割程度あるか（事実の羅列だけになっていないか）**
- [ ] **「他のサイトでも読めるまとめ」になっていないか。この記事でしか得られない情報や視点があるか**
